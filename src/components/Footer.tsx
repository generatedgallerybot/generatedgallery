        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div className="space-y-3">
            ...
            <p className="text-[13px] text-white/40 leading-relaxed max-w-xs">
              A free AI art gallery, model asset board, and metadata-only prompt dataset. Browse images, publish LoRAs/workflows, study prompts, and build on open JSONL exports.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <h4 className="text-[11px] uppercase tracking-widest text-white/40">Dataset</h4>
            <div className="flex flex-col gap-2">
              <a href="/ai-image-dataset" className="text-[13px] text-white/50 hover:text-white/80 transition-colors">AI image dataset</a>
              <a href="/ai-prompt-dataset" className="text-[13px] text-white/50 hover:text-white/80 transition-colors">AI prompt dataset</a>
              <a href="/jsonl-ai-image-dataset" className="text-[13px] text-white/50 hover:text-white/80 transition-colors">JSONL AI image dataset</a>
              <a href="/stable-diffusion-prompt-dataset" className="text-[13px] text-white/50 hover:text-white/80 transition-colors">Stable Diffusion prompt dataset</a>
              <a href="/protocol" className="text-[13px] text-white/50 hover:text-white/80 transition-colors">Protocol</a>
